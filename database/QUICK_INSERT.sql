-- ============================================================================
-- INSERIR DADOS DE TESTE - COPIE E COLE NO SUPABASE
-- ============================================================================

-- PASSO 1: Copie e cole TUDO isto no Supabase SQL Editor
-- PASSO 2: Clique RUN
-- PRONTO!

-- Substituiremos auth.uid() por um trigger que insere automaticamente
-- Execute isto:
