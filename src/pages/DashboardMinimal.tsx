...
import { ComposedChart, AreaChart, BarChart, Area, Bar, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
...
export default function DashboardMinimal() {
  ...
  const { data: dadosFunil, loading: loadingFunil, error: errorFunil } = useFunnelData();
  const { data: metrics, loading: loadingMetrics, error: errorMetrics } = useCustomerMetrics();

  const [visibleReceita] = useState({
    receita: true,
    meta: true,
  });
